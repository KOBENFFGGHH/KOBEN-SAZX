...
local Library = Update:Window("KOBEN&ไทย🇹🇭  ","",Enum.KeyCode.RightControl);
local AutoFarm = Library:Tab("❤️ฟาร์ม")
local Auto = Library:Tab("❤️ทำของ")
local Stats = Library:Tab("⚡️สแตด")
local tp = Library:Tab("⚡️บิน")
local Dungeon = Library:Tab("⚡️ดัน + มอง")
local DevilFruit = Library:Tab("🇹🇭ผล")
local Shop = Library:Tab("⚡️ซื้อของ")
local Misc = Library:Tab("⚡️ร่วม")
local Setting = Library:Tab("❤️ตั้งค่า")
local Cr = Library:Tab("⚡️ดิส")
